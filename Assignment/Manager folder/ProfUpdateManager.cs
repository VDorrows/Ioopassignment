...
{
    public partial class frmProfUpdate : Form
    {
        public string email;
        private string connectionString;

        public frmProfUpdate(string email)
        {
            InitializeComponent();
        ...
        private void ProfUpdateManager_Load(object sender, EventArgs e)
        {
